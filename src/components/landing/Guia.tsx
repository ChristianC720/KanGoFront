      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <FormField label="Punto de partida">
            <select className="w-full px-3 py-2 rounded-lg border-2 border-transparent hover:border-green-300 focus:border-green-500 focus:outline-none transition-colors" name="puntoPartida">
          ...
          <FormField label="Destino">
            <select className="w-full px-3 py-2 rounded-lg border-2 border-transparent hover:border-green-300 focus:border-green-500 focus:outline-none transition-colors" name="destinos">
              {destinos.map((punto) => (
                <option key={punto} value={punto}>{punto}</option>
              ))}
            </select>
          ...
          <FormField label="Fecha de salida">
            <input className="w-full px-3 py-2 rounded-lg border-2 border-transparent hover:border-green-300 focus:border-green-500 focus:outline-none transition-colors"
        ...
        <div className="flex justify-end mt-4">
          <button type="submit" className="px-6 py-2 rounded-lg font-bold text-lg bg-white text-black hover:bg-gray-100 transition-colors">
            Seleccionar
          </button>
        </div>
      </form>
